...
#define CHAR_BIT __CHAR_BIT__
     ...
     defined(__AARCH64EL__) || defined(_MIPSEL) || defined(_M_IX86) || defined(_M_X64) ||          \
     defined(_M_ARM)) &&                                                                           \
...
#define PB_SIZE_MAX ((pb_size_t) - 1)
    ...
    struct pb_field_iter_s
    {
        ...
        void* pData;  /* Pointer to current data contents. Different than pField for arrays and
                         pointers. */
...
#define PB_BIND(msgname, structname, width)                                                        \
    const uint32_t structname##_field_info[] PB_PROGMEM = { msgname##_FIELDLIST(                   \
      PB_GEN_FIELD_INFO_##width, structname) 0 };                                                  \
    const pb_msgdesc_t* const structname##_submsg_info[] = { msgname##_FIELDLIST(                  \
      PB_GEN_SUBMSG_INFO, structname) NULL };                                                      \
...
#define PB_GEN_FIELD_INFO_AUTO(structname, atype, htype, ltype, fieldname, tag)                    \
    PB_FIELDINFO_AUTO2(                                                                            \
      PB_FIELDINFO_WIDTH_AUTO(_PB_ATYPE_##atype, _PB_HTYPE_##htype, _PB_LTYPE_##ltype),            \
      tag,                                                                                         \
      PB_ATYPE_##atype | PB_HTYPE_##htype | PB_LTYPE_MAP_##ltype,                                  \
      PB_DATA_OFFSET_##atype(_PB_HTYPE_##htype, structname, fieldname),                            \
      PB_DATA_SIZE_##atype(_PB_HTYPE_##htype, structname, fieldname),                              \
...
#define PB_FIELDINFO_ASSERT_AUTO2(                                                                 \
  width, tag, type, data_offset, data_size, size_offset, array_size)                               \
...
#define PB_SO_PB_HTYPE_ONEOF(structname, fieldname)                                                \
    PB_SO_PB_HTYPE_ONEOF2(                                                                         \
      structname, PB_ONEOF_NAME(FULL, fieldname), PB_ONEOF_NAME(UNION, fieldname))
...
#define PB_SUBMSG_INFO_ONEOF(ltype, structname, fieldname)                                         \
    PB_SUBMSG_INFO_ONEOF2(                                                                         \
      ltype, structname, PB_ONEOF_NAME(UNION, fieldname), PB_ONEOF_NAME(MEMBER, fieldname))
...
#define PB_SUBMSG_DESCRIPTOR(t) &(t##_msg),
     ...
     * 1 word:  [2-bit len] [6-bit tag] [8-bit type] [8-bit data_offset] [4-bit size_offset] [4-bit
     * data_size]
     *
...
#define PB_FIELDINFO_1(tag, type, data_offset, data_size, size_offset, array_size)                 \
    (0 | (((uint32_t)(tag) << 2) & 0xFF) | ((type) << 8) |                                         \
     (((uint32_t)(data_offset) & 0xFF) << 16) | (((uint32_t)(size_offset) & 0x0F) << 24) |         \
     (((uint32_t)(data_size) & 0x0F) << 28)),

#define PB_FIELDINFO_2(tag, type, data_offset, data_size, size_offset, array_size)                 \
    (1 | (((uint32_t)(tag) << 2) & 0xFF) | ((type) << 8) |                                         \
     (((uint32_t)(array_size) & 0xFFF) << 16) | (((uint32_t)(size_offset) & 0x0F) << 28)),         \
      (((uint32_t)(data_offset) & 0xFFFF) | (((uint32_t)(data_size) & 0xFFF) << 16) |              \
       (((uint32_t)(tag) & 0x3c0) << 22)),

#define PB_FIELDINFO_4(tag, type, data_offset, data_size, size_offset, array_size)                 \
    (2 | (((uint32_t)(tag) << 2) & 0xFF) | ((type) << 8) |                                         \
...
#define PB_FIELDINFO_ASSERT_1(tag, type, data_offset, data_size, size_offset, array_size)          \
    PB_STATIC_ASSERT(PB_FITS(tag, 6) && PB_FITS(data_offset, 8) && PB_FITS(size_offset, 4) &&      \
                       PB_FITS(data_size, 4) && PB_FITS(array_size, 1),                            \
...
#define PB_FIELDINFO_ASSERT_4(tag, type, data_offset, data_size, size_offset, array_size)          \
    PB_STATIC_ASSERT(PB_FITS(tag, 16) && PB_FITS(data_offset, 16) &&                               \
                       PB_FITS((int_least8_t)size_offset, 8) && PB_FITS(data_size, 16) &&          \
 ...
 * Note that the checks are against 31 bits to avoid compiler warnings about shift wider than type
 * in the test. I expect that there is no reasonable use for >2GB messages with nanopb anyway.
 */
#define PB_FIELDINFO_ASSERT_4(tag, type, data_offset, data_size, size_offset, array_size)          \
